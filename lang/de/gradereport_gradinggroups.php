...
$string['groupselection_help'] = 'Wählen Sie die Gruppen aus, für die Sie die gewählte Referenznote und das Feedback kopieren möchten, indem Sie die entsprechenden Kontrollkästchen aktivieren. Falls nur eine Gruppe angezeigt wird, wählen Sie die Quelle für die Kopie der gewählten Note über die entsprechende Schaltfläche rechts neben dem Eintrag aus.';
...
$string['not_graded_by_me'] = 'Wurde von jemand anderes bewertet';
$string['overwrite_label'] = 'Überschreibe vorhandene Bewertungen';
$string['pluginname'] = 'Gruppenbewertung';
$string['privacy:metadata'] = 'Das Plugin Gruppenbewertung speichert keine personenbezogenen Daten.';
$string['reference_grade_feedback'] = 'Referenzbewertung oder Referenzkommentar';
